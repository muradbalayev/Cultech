...
const BlogHero = () => {
    ...
    return (
        <div
            className="w-full h-[90vh] bg-cover bg-center flex gap-20 md:p-0 p-6 items-center justify-center"
            style={{ backgroundImage: `url(${hero2})` }}
        >
            <div className="text-center md:w-1/2 w-full text-white bg-black bg-opacity-50 p-8 rounded-lg">
            ...
            <div className="bg-white md:block hidden w-[400px] shadow-md rounded-lg overflow-hidden">
                <img
                    src={blog.image}
                    alt={blog.title}
